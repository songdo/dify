<<<<<<< HEAD:web/app/components/plugins/plugin-detail-panel/tool-selector/tool-item.tsx
'use client'
import {
  RiDeleteBinLine,
  RiEqualizer2Line,
...
export default ToolItem
>>>>>>> upstream/main:web/app/components/plugins/plugin-detail-panel/tool-selector/components/tool-item.tsx
