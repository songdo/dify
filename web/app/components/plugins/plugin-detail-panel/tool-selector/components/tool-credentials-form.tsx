<<<<<<< HEAD:web/app/components/plugins/plugin-detail-panel/tool-selector/tool-credentials-form.tsx
'use client'
...
export default React.memo(ToolCredentialForm)
>>>>>>> upstream/main:web/app/components/plugins/plugin-detail-panel/tool-selector/components/tool-credentials-form.tsx
