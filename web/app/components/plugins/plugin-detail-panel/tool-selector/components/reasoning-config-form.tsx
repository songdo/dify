<<<<<<< HEAD:web/app/components/plugins/plugin-detail-panel/tool-selector/reasoning-config-form.tsx
...
export default ReasoningConfigForm
>>>>>>> upstream/main:web/app/components/plugins/plugin-detail-panel/tool-selector/components/reasoning-config-form.tsx
