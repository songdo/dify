<<<<<<< HEAD:web/app/components/plugins/plugin-detail-panel/subscription-list/use-subscription-list.spec.ts
...
>>>>>>> upstream/main:web/app/components/plugins/plugin-detail-panel/subscription-list/__tests__/use-subscription-list.spec.ts
