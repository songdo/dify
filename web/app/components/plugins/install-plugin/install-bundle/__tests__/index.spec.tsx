<<<<<<< HEAD:web/app/components/plugins/install-plugin/install-bundle/index.spec.tsx
...
>>>>>>> upstream/main:web/app/components/plugins/install-plugin/install-bundle/__tests__/index.spec.tsx
