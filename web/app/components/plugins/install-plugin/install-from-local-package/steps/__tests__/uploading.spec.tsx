<<<<<<< HEAD:web/app/components/plugins/install-plugin/install-from-local-package/steps/uploading.spec.tsx
...
>>>>>>> upstream/main:web/app/components/plugins/install-plugin/install-from-local-package/steps/__tests__/uploading.spec.tsx
