<<<<<<< HEAD:web/app/components/plugins/install-plugin/install-from-local-package/index.spec.tsx
...
>>>>>>> upstream/main:web/app/components/plugins/install-plugin/install-from-local-package/__tests__/index.spec.tsx
