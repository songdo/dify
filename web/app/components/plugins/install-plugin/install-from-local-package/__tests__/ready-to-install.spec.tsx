<<<<<<< HEAD:web/app/components/plugins/install-plugin/install-from-local-package/ready-to-install.spec.tsx
...
>>>>>>> upstream/main:web/app/components/plugins/install-plugin/install-from-local-package/__tests__/ready-to-install.spec.tsx
