<<<<<<< HEAD:web/app/components/plugins/install-plugin/install-from-github/index.spec.tsx
...
>>>>>>> upstream/main:web/app/components/plugins/install-plugin/install-from-github/__tests__/index.spec.tsx
