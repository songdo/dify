<<<<<<< HEAD:web/app/components/plugins/install-plugin/install-from-github/steps/selectPackage.spec.tsx
...
>>>>>>> upstream/main:web/app/components/plugins/install-plugin/install-from-github/steps/__tests__/selectPackage.spec.tsx
