<<<<<<< HEAD:web/app/components/plugins/install-plugin/install-from-marketplace/steps/install.spec.tsx
...
>>>>>>> upstream/main:web/app/components/plugins/install-plugin/install-from-marketplace/steps/__tests__/install.spec.tsx
