<<<<<<< HEAD:web/app/components/plugins/install-plugin/install-from-marketplace/index.spec.tsx
...
>>>>>>> upstream/main:web/app/components/plugins/install-plugin/install-from-marketplace/__tests__/index.spec.tsx
