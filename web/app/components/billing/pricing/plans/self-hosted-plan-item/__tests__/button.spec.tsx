<<<<<<< HEAD:web/app/components/billing/pricing/plans/self-hosted-plan-item/button.spec.tsx
...
>>>>>>> upstream/main:web/app/components/billing/pricing/plans/self-hosted-plan-item/__tests__/button.spec.tsx
